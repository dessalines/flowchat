...
import { Theme } from './user-settings.interface';
...
export class Tools {
  ...
  static applyTheme(theme: Theme) {
    // Cyborg is dark, lumen is light
    let bootswatchTheme = (theme == Theme.Dark) ? "cyborg" : "lumen";
    let file = "https://bootswatch.com/4/" + bootswatchTheme + "/bootstrap.min.css";
